...
SESSION_DAYS = 30
MAX_PHOTOS = 8
COMMISSION_USD = int(os.environ.get("MOTORCRIOLLO_COMMISSION") or "80")
...
try:
    ...
    pass
try:
    from config_local import PUBLISH_FEE_USD as _PFEE

    PUBLISH_FEE_USD = int(_PFEE or PUBLISH_FEE_USD)
except Exception:
    pass
try:
